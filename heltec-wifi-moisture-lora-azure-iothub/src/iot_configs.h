...
// Azure IoT
#define IOT_CONFIG_IOTHUB_FQDN "<IOT HUB URL, SAMPLE: iothub-eastus2.azure-devices.net>"
#define IOT_CONFIG_DEVICE_ID "<IOT HUB URL DEVICE ID: heltec-1>"
// Use device key if not using certificates
#ifndef IOT_CONFIG_USE_X509_CERT
#define IOT_CONFIG_DEVICE_KEY "<IOT HUB URL DEVICE ID KEY>"
#endif // IOT_CONFIG_USE_X509_CERT
...
//Sensor
#define std::string SENSOR_NAME = "ID010950"
